...
const divisions = [
  {
    name: "RR Concrete",
    description: "Concrete flatwork, driveways, sidewalks, patios, slabs, and skilled labor opportunities built on reliability and pride.",
    icon: HardHat,
    accent: "text-orange-500",
  },
  {
    name: "RR Roofing",
    description: "Roofing, exterior work, repairs, and restoration services built around safety, skill, and dependable crews.",
    icon: Home,
    accent: "text-green-600",
  },
  {
    name: "RR Landscaping",
    description: "Landscaping, outdoor improvements, seasonal maintenance, and property support services that create more pathways to work.",
    icon: Leaf,
    accent: "text-blue-600",
  },
  {
    name: "RR Workforce",
    description: "Recovery-informed workforce support, case management, stabilization, and employment readiness for long-term success.",
    icon: Users,
      ...
      <main>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="mb-12 flex flex-col justify-between gap-6 md:flex-row md:items-end">
              ...
              <p className="max-w-xl text-lg leading-8 text-neutral-600">
                Recovery Rebuilt is built as one parent brand with multiple service divisions: concrete, roofing, landscaping, and workforce support. Each division creates practical services for customers and real career pathways for workers.
              </p>
            </div>
        ...
        <section id="contact" className="bg-neutral-100 px-6 py-20 text-neutral-950">
          <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-[0.9fr_1.1fr] md:items-start">
            ...
            <form action="https://formsubmit.co/j.fugalli@recoveryrebuilt.com" method="POST" className="rounded-[2rem] bg-white p-7 shadow-xl">
              <input type="hidden" name="_subject" value="New Recovery Rebuilt website inquiry" />
              <input type="hidden" name="_captcha" value="false" />
              <div className="grid gap-5 sm:grid-cols-2">
                <input name="name" required className="rounded-2xl border border-neutral-200 bg-neutral-50 px-4 py-4 outline-none focus:border-orange-500" placeholder="Name" />
                <input name="email" type="email" required className="rounded-2xl border border-neutral-200 bg-neutral-50 px-4 py-4 outline-none focus:border-orange-500" placeholder="Email" />
              </div>
