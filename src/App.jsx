...
import { ArrowUpRight, HardHat, Home, Truck, Users, ShieldCheck, HeartHandshake, Building2, Mail, Phone, MapPin, CheckCircle2 } from "lucide-react";
...
const divisions = [
  {
    name: "RR Concrete",
    description: "Concrete work, job-site training, and skilled labor opportunities built on reliability and pride.",
    icon: HardHat,
    accent: "text-orange-500",
  },
  {
    name: "RR Roofing",
    description: "A future trade division designed to create career pathways in roofing, exterior work, and restoration.",
    icon: Home,
    accent: "text-green-600",
  },
  {
    name: "RR Moving",
    description: "A future service division focused on dependable crews, logistics, and entry-level employment pathways.",
    icon: Truck,
    accent: "text-blue-600",
  },
  {
    name: "RR Workforce Services",
    description: "Recovery-informed workforce support, case management, stabilization, and partner coordination.",
    icon: Users,
    ...
    <div className="min-h-screen bg-neutral-950 text-white">
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs uppercase tracking-[0.25em] text-orange-500">Building Stability</p>
            </div>
          </div>
          <nav className="hidden items-center gap-8 text-sm font-semibold text-neutral-300 md:flex">
            <a href="#services" className="hover:text-orange-500">Services</a>
            <a href="#mission" className="hover:text-orange-500">Mission</a>
      ...
      <main>
          ...
          <div className="mx-auto grid max-w-7xl gap-12 px-6 py-24 md:grid-cols-[1.1fr_0.9fr] md:py-32">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="relative z-10">
              ...
              <h1 className="max-w-4xl text-5xl font-black uppercase leading-[0.92] tracking-tight md:text-7xl">
                Building Stability. <span className="text-orange-500">Rebuilding Lives.</span>
              </h1>
              <p className="mt-7 max-w-2xl text-lg leading-8 text-neutral-300 md:text-xl">
                Recovery Rebuilt creates real employment pathways in the trades while surrounding workers with the support, structure, and accountability needed to stay stable, sober, housed, and employed.
              </p>
        ...
        <section id="services" className="bg-neutral-100 px-6 py-20 text-neutral-950">
          <div className="mx-auto max-w-7xl">
            <div className="mb-12 flex flex-col justify-between gap-6 md:flex-row md:items-end">
              <div>
                <p className="mb-3 text-sm font-black uppercase tracking-[0.24em] text-orange-600">One Brand. Many Ways To Build.</p>
                <h2 className="max-w-3xl text-4xl font-black uppercase tracking-tight md:text-5xl">A brand system built for growth beyond one trade.</h2>
              </div>
              <p className="max-w-xl text-lg leading-8 text-neutral-600">
                Start with concrete. Grow into roofing, moving, landscaping, workforce services, and other employment pathways under the same Recovery Rebuilt identity.
              </p>
            </div>
                ...
                return (
                  <Card key={division.name} className="border-neutral-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
                    <CardContent className="p-7">
                      ...
                      <p className="leading-7 text-neutral-600">{division.description}</p>
                    </CardContent>
                  </Card>
                );
              })}
        ...
        <section id="mission" className="px-6 py-20">
          <div className="mx-auto grid max-w-7xl gap-12 md:grid-cols-[0.9fr_1.1fr] md:items-center">
            <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-2xl">
              <p className="text-sm font-black uppercase tracking-[0.24em] text-orange-500">Our Mission</p>
              <h2 className="mt-4 text-4xl font-black uppercase tracking-tight md:text-5xl">Employment alone is not enough.</h2>
              <p className="mt-6 text-lg leading-8 text-neutral-300">
                People in recovery often need more than a job. They need structure, accountability, transportation support, housing stability, skill-building, and people who understand the real barriers that can lead to job loss or relapse.
              </p>
            </div>
            <div className="grid gap-5 sm:grid-cols-2">
              {values.map((value) => {
                ...
                return (
                  <div key={value.title} className="rounded-3xl border border-white/10 bg-neutral-900 p-6">
                    <Icon className="mb-5 h-9 w-9 text-orange-500" />
                    <h3 className="mb-2 text-xl font-black uppercase tracking-wide">{value.title}</h3>
        ...
        <section id="workforce" className="bg-white px-6 py-20 text-neutral-950">
          <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              <p className="mb-3 text-sm font-black uppercase tracking-[0.24em] text-orange-600">Workforce Support</p>
              <h2 className="text-4xl font-black uppercase tracking-tight md:text-5xl">The bridge between recovery and long-term employment.</h2>
              <p className="mt-6 text-lg leading-8 text-neutral-600">
                Recovery Rebuilt is designed to help workers stay reliable on the job by addressing the barriers that often happen outside of work: housing, transportation, appointments, court requirements, stress, conflict, and relapse risk.
              </p>
              <div className="mt-8 grid gap-4">
                {supportPoints.map((point) => (
                  <div key={point} className="flex items-start gap-3 rounded-2xl bg-neutral-100 p-4">
            ...
            <div className="rounded-[2rem] bg-neutral-950 p-8 text-white shadow-2xl">
              <div className="mb-8 flex items-center justify-between border-b border-white/10 pb-6">
                <div>
                  <p className="text-sm font-black uppercase tracking-[0.24em] text-orange-500">Daily Flow</p>
                  <h3 className="mt-2 text-3xl font-black uppercase">Structure Creates Stability</h3>
                </div>
        ...
        <section id="partners" className="px-6 py-20">
          <div className="mx-auto max-w-7xl rounded-[2rem] border border-white/10 bg-gradient-to-br from-neutral-900 to-neutral-800 p-8 shadow-2xl md:p-12">
            <div className="grid gap-10 md:grid-cols-[1fr_0.9fr] md:items-center">
              <div>
                <p className="mb-3 text-sm font-black uppercase tracking-[0.24em] text-orange-500">Partner With Us</p>
                <h2 className="text-4xl font-black uppercase tracking-tight md:text-5xl">Built for colleges, employers, community partners, and workforce programs.</h2>
                <p className="mt-6 text-lg leading-8 text-neutral-300">
                  Recovery Rebuilt can work with training partners, recovery organizations, employers, and public workforce systems to create supported employment pipelines that are practical, measurable, and mission-aligned.
                </p>
              </div>
        ...
        <section id="contact" className="bg-neutral-100 px-6 py-20 text-neutral-950">
          <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-[0.9fr_1.1fr] md:items-start">
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-neutral-600">Reach out for concrete work, partnership conversations, workforce pathways, or employment opportunities.</p>
              <div className="mt-8 space-y-4 text-neutral-700">
                <div className="flex items-center gap-3"><Mail className="h-5 w-5 text-orange-600" /> info@recoveryrebuilt.com</div>
                <div className="flex items-center gap-3"><Phone className="h-5 w-5 text-orange-600" /> Add business phone number</div>
                <div className="flex items-center gap-3"><MapPin className="h-5 w-5 text-orange-600" /> Minnesota</div>
              </div>
            </div>
            <form className="rounded-[2rem] bg-white p-7 shadow-xl" action="mailto:info@recoveryrebuilt.com" method="post" encType="text/plain">
              <div className="grid gap-5 sm:grid-cols-2">
                <input name="name" className="rounded-2xl border border-neutral-200 bg-neutral-50 px-4 py-4 outline-none focus:border-orange-500" placeholder="Name" />
                <input name="email" type="email" className="rounded-2xl border border-neutral-200 bg-neutral-50 px-4 py-4 outline-none focus:border-orange-500" placeholder="Email" />
              </div>
              <input name="subject" className="mt-5 w-full rounded-2xl border border-neutral-200 bg-neutral-50 px-4 py-4 outline-none focus:border-orange-500" placeholder="What are you reaching out about?" />
              <textarea name="message" className="mt-5 min-h-36 w-full rounded-2xl border border-neutral-200 bg-neutral-50 px-4 py-4 outline-none focus:border-orange-500" placeholder="Message" />
              <Button type="submit" className="mt-5 w-full py-6 text-base font-black uppercase tracking-wide">Send Message</Button>
            </form>
          </div>
        </section>
      </main>
      ...
      <footer className="border-t border-white/10 px-6 py-8">
        <div className="mx-auto flex max-w-7xl flex-col justify-between gap-4 text-sm text-neutral-400 md:flex-row md:items-center">
          ...
          <p>Construction • Workforce • Recovery Support</p>
        </div>
      </footer>
    </div>
  );
